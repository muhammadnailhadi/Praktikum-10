...
<html>
<head>
  <title>COVID-19 Asia Total Recovered Statistics</title>
...
<body>
  ...
  $sql = "SELECT country, total_recovered FROM data_covid";
  ...
  <script>
    ...
    var total_recovered = <?php echo json_encode($total_recovered); ?>;
    ...
    var barChart = new Chart(barCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Total Recovered by Country (Bar Chart)'
        },
        scales: {
          y: {
            beginAtZero: true
    ...
    var lineChart = new Chart(lineCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Total Recovered by Country (Line Chart)'
        },
        scales: {
          y: {
            beginAtZero: true
    ...
    var pieChart = new Chart(pieCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Total Recovered by Country (Pie Chart)'
        }
      }
    });
    ...
    var doughnutChart = new Chart(doughnutCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Total Recovered by Country (Doughnut Chart)'
        }
      }
    });
  </script>
