...
<html>
<head>
  <title>COVID-19 Asia Active Cases Statistics</title>
...
<body>
  ...
  $sql = "SELECT country, active_cases FROM data_covid";
  ...
  <script>
    ...
    var active_cases = <?php echo json_encode($active_cases); ?>;
    ...
    var barChart = new Chart(barCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Active Cases by Country (Bar Chart)'
        },
        scales: {
          y: {
            beginAtZero: true
    ...
    var lineChart = new Chart(lineCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Active Cases by Country (Line Chart)'
        },
        scales: {
          y: {
            beginAtZero: true
    ...
    var pieChart = new Chart(pieCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Active Cases by Country (Pie Chart)'
        }
      }
    });
    ...
    var doughnutChart = new Chart(doughnutCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Active Cases by Country (Doughnut Chart)'
        }
      }
    });
  </script>
