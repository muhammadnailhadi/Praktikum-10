...
<html>
<head>
  <title>COVID-19 Asia Total Tests Statistics</title>
...
<body>
  ...
  $sql = "SELECT country, total_tests FROM data_covid";
  ...
  <script>
    ...
    var total_tests = <?php echo json_encode($total_tests); ?>;
    ...
    var barChart = new Chart(barCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Total Tests by Country (Bar Chart)'
        },
        scales: {
          y: {
            beginAtZero: true
    ...
    var lineChart = new Chart(lineCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Total Tests by Country (Line Chart)'
        },
        scales: {
          y: {
            beginAtZero: true
    ...
    var pieChart = new Chart(pieCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Total Tests by Country (Pie Chart)'
        }
      }
    });
    ...
    var doughnutChart = new Chart(doughnutCtx, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Total Tests by Country (Doughnut Chart)'
        }
      }
    });
  </script>
